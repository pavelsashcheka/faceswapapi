...
def faceswap(image, background):
    ...
    background_image = Image.open(f'/app/api/backgrounds/{background}')
    ...
    im1, landmarks1 = read_im_and_landmarks(background_cv_image)
    im2, landmarks2 = read_im_and_landmarks(cv_image)
